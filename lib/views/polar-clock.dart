...
class _PolarClockState extends State<PolarClock> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('', style: TextStyle(color: ThemeColors.textColor)),
            elevation: 0,
  ...
  List _getDotPosition() {
    double x = 128 +
        128 * cos((pi / 2) - _oracowlService.polaris['hour_angle_radians']);
    double y = 128 +
        128 * sin((pi / 2) - _oracowlService.polaris['hour_angle_radians']);
